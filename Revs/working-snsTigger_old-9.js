            ...
            dynamoDB_documentClient.scan(scanningProperties, function(error, data) {
                if (error) {
                    ...
                    if (data.LastEvaluatedKey) {
                        ...
                        //let recentTests_JSON = JSON.parse(recentTests);

                        //console.log(typeof recentTests);
                        //console.log(recentTests.length);
                        //console.log(recentTests.length);
                        //console.log(recentTests_JSON.length);
                        //console.log(typeof recentTests_JSON);
                        //recentTests

                        for (var i = recentTests.length - 1; i >= 0; i--){
                            //console.log(typeof recentTests[i]);

                            let dataJSON = JSON.parse(recentTests[i].data);
                            //console.log(typeof data);
                            //console.log(Object.keys(recentTests[i]));
                            // var auditsJSON  = JSON.parse(audits);
                            if(dataJSON.audits){
                                //console.log(typeof dataJSON.audits);
                                // var auditsJSON  = JSON.parse(audits);
                            ...
                            // if(recentTests[i].data["audits"]){
                            //     //console.log(Object.keys(recentTests[i].data["audits"]));
                            // }


                            // if(audits.hasOwnProperty("details")){
                            //     console.log('yeeep');
                            // }
                            // for (var data in recentTests[i].data){
                            //   console.log(test)
                            // if (test.hasOwnProperty("details")){
                        ...
                        // console.log(Object.keys(recentTests));
                        // recentTests.forEach((test)=>{
                        //     test.audits.forEach((audit)=>{
                        //         if(audit.hasOwnProperty("details")){
                        //             delete audit.details;
                        //         }
                        //     });
